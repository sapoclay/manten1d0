...
class VentanaPrincipal:
    def __init__(self, root):
        ...
        self.root.protocol("WM_DELETE_WINDOW", self.cerrar_ventana_principal)  # Asociar la función al evento de cierre de ventana
        ...
        # Crear el menú About
        self.menu_superior.add_command(label="About", command=mostrar_about)  # Llama a mostrar_about cuando se haga clic
        ...
        self.label_bienvenida = tk.Label(self.area_central, text="¡Bienvenido!\n Comienza haciendo clic\n en una categoría del menú lateral.", font=("Arial", 18, "bold"), bg="lightgrey")
        self.label_bienvenida.pack(pady=50)
        
        # Contenedor para el label de subcategorías
        self.frame_subcategorias = tk.Frame(self.area_central, bg="lightgrey", padx=10, pady=10)  # Ajustar el espaciado interno
        self.frame_subcategorias.pack(anchor="n", pady=(0, 20))  # Espaciado en la parte superior y anclar al norte
        
        self.label_subcategorias = tk.Label(self.area_central, text="", font=("Arial", 12), bg="lightgrey", padx=10, pady=0)
        ...
        self.texto_informacion = tk.Text(self.contenedor_texto, wrap=tk.WORD, font=("Arial", 12), state=tk.DISABLED)
        ...
        self.scrollbar_vertical = ttk.Scrollbar(self.contenedor_texto, orient="vertical", command=self.texto_informacion.yview)
    ...
    def mostrar_subcategorias(self, categoria):
        ...
        if categoria == "Información":
            ...
            if mensaje_personalizado:
                self.label_subcategorias.config(text=mensaje_personalizado, font=("Arial", 14, "bold"))  # Ajustar el texto al mensaje personalizado
            else:
                self.label_subcategorias.config(text=f"Subcategorías de {categoria}", font=("Arial", 12))  # Restaurar el texto original
    ...
    def mostrar_informacion_sistema(self):
        ...
        self.texto_informacion.insert(tk.END, "\nInformación de la Memoria:\n", "bold")  # Texto "Información de la Memoria" en negrita
